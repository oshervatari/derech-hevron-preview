...
DH.apartmentTypes = [
  ...
  { code: '3B',   rooms: 3, gross: 75.2,  net: 72.7,  balcony: 12.0, terrace: 0,    img: 'assets/img/plans/type-3B.png?v=2',   _source: 'דף טיפוס 3B מהאדריכל (26.02.2026)' },
  { code: '3C',   rooms: 3, gross: 81.0,  net: 77.7,  balcony: 12.0, terrace: 0,    img: 'assets/img/plans/type-3C.png?v=2',   _source: 'דף טיפוס 3C מהאדריכל (26.02.2026)' },
  // 3D1+3D2 = one resident DUPLEX on floors 11-12, total 147.9 מ״ר (sheet "3D").
  // catalogHide: the duplex is already taken (תפוסה) so it stays out of the
  // public type catalog; the plans still open from the tower-map unit popups.
  { code: '3D1',  rooms: 3, gross: 81.0,  net: 77.7,  balcony: 12.0, terrace: 0,    img: 'assets/img/plans/type-3D1.png',  catalogHide: true, _source: 'דף טיפוס 3D מהאדריכל (23.08.2026)', _note: 'המפלס התחתון של דופלקס 3D בקומות 11-12 (שטח כולל 147.9 מ״ר)' },
  { code: '3D2',  rooms: 3, gross: 66.9,  net: 64.4,  balcony: 0,    terrace: 0,    img: 'assets/img/plans/type-3D2.png',  catalogHide: true, _source: 'דף טיפוס 3D מהאדריכל (23.08.2026)', _note: 'המפלס העליון של דופלקס 3D בקומות 11-12 (שטח כולל 147.9 מ״ר)' },
  // 4-room
  { code: '4A',   rooms: 4, gross: 104.1, net: 100.7, balcony: 12.0, terrace: 0,    img: 'assets/img/plans/type-4A.png?v=2', _source: 'דף טיפוס 4A-L מהאדריכל (24.08.2026)' },
  { code: '4B',   rooms: 4, gross: 104.1, net: 99.5,  balcony: 10.4, terrace: 0,    img: 'assets/img/plans/type-4B.png?v=2', _source: 'דף טיפוס 4B מהאדריכל (24.08.2026)' },
  { code: '4C',   rooms: 4, gross: 96.0,  net: 92.7,  balcony: 10.5, terrace: 0,    img: 'assets/img/plans/type-4C.png',   catalogHide: true, _source: 'PPTX slide 6', _hideNote: 'הוסר מהקטלוג לבקשת הלקוח (26.08.2026)' },
  // 5-room
  ...
  { code: '5D',   rooms: 5, gross: 175.5, net: 168.1, balcony: 10.6, terrace: 57.6, img: 'assets/img/plans/type-5D.png',   catalogHide: true, _source: 'PPTX slide 11', _note: 'גרסת דף הטיפוסים - בתשריט ד מופיע 5D בשטח ~147.7', _hideNote: 'הוסר מהקטלוג לבקשת הלקוח (26.08.2026)' },
  // 6-room (penthouse-grade)
  { code: '6A',   rooms: 6, gross: 193.1, net: 184.8, balcony: 10.6, terrace: 82.8, img: 'assets/img/plans/type-6A.png',   catalogHide: true, _source: 'PPTX slide 12', _hideNote: 'הוסר מהקטלוג לבקשת הלקוח (26.08.2026)' },
  { code: '6B',   rooms: 6, gross: 148.4, net: 141.8, balcony: 40.2, terrace: 0,    img: 'assets/img/plans/type-6B.png',   catalogHide: true, _source: 'PPTX slide 13', _hideNote: 'הוסר מהקטלוג לבקשת הלקוח (26.08.2026)' },
  { code: '6C',   rooms: 6, gross: 156.3, net: 150.4, balcony: 15.1, terrace: 0,    img: 'assets/img/plans/type-6C.png',   catalogHide: true, _source: 'PPTX slide 14', _hideNote: 'הוסר מהקטלוג לבקשת הלקוח (26.08.2026)' },
];
